...
import chemistmod.powers.GoliathTonicPower;
...
public class GoliathTonic extends BaseChemistCard {
    public static final String CARD_ID = ChemistMod.makeId("GoliathTonic");
    ...
    public void use(AbstractPlayer player, AbstractMonster monster) {
        addToBot(new ApplyPowerAction(player, player, new GoliathTonicPower(player, this.magicNumber)));
