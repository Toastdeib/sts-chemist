...
public class PharmacologyPower extends AbstractPower {
    public static final String POWER_ID = ChemistMod.makeId("PharmacologyPower");
    private static final PowerStrings POWER_STRINGS = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public PharmacologyPower(AbstractCreature owner, int amount) {
    ...
    // TODO - Figure out the correct override to hook into for potions. Or maybe just rethink this card effect entirely.
}
